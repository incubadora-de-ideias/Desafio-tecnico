...
class Sistema_de_Gestao_Escolar():
    ...
    def Administrar(self):
        ...
        for aluno in alunos:
            aluno_button = CTkButton(self.frame_alunos, text=f'   {aluno["nome"]}', anchor='w', font=('Time', 15, 'bold'), height=44, width=440, fg_color='#212121', command=lambda: self.abrir_aluno(aluno))
