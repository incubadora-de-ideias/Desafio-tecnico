...
<head>
    ...
    <title>Sistema de gestão escolar - IPIL | Painel do Administrador</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pag/alunos.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pag/pf.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pag/curricular.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pag/ter.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Painel do Administrador</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php
                  $query = "SELECT count(id) as total from aluno";
